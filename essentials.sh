...
puppetmasterip="172.28.128.3"                                       # replace with the IP of your puppetmaster
puppetagentip="172.28.128.4"                                        # replace with the  IP of your puppetagent
puppetmasterhost="master.puppet.org"                                # hostname of the puppetmaster, you can change it to your own preferences
puppetagenthost="agentone.puppet.org"                               # hostname of the puppetagent, you can change it to your own preferences
